...
const Login = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      email: Yup.string().email("Email không hợp lệ").required("Vui lòng nhập trường email"),
        ...
        <div className="lg:w-1/2 xl:max-w-screen-sm">
          <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
            <div className="cursor-pointer flex items-center">
              <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold flex items-center gap-x-2">
                <img
            ...
            <div className="mt-12">
              <form onSubmit={formik.handleSubmit}>
                <div>
                  ...
                  />
                  {formik.touched.email && formik.errors.email ? <div className="text-red-500 text-sm mt-2">{formik.errors.email}</div> : null}
                </div>
                <div className="mt-8">
                  ...
                  />
                  {formik.touched.password && formik.errors.password ? <div className="text-red-500 text-sm mt-2">{formik.errors.password}</div> : null}
              ...
              <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                Tạo tài khoản
                <a className="cursor-pointer text-indigo-600 hover:text-indigo-800">Đăng ký</a>
              </div>
            </div>
          </div>
        </div>
